            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nama" value="<?= $data['profil']['nama']; ?>" class="pl-10 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm py-2.5" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="kontak" value="<?= $data['profil']['kontak']; ?>" class="pl-10 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm py-2.5">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="alamat" rows="3" class="pl-10 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm py-2" required><?= $data['profil']['alamat']; ?></textarea>
                    </div>
                </div>
