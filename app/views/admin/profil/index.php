            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nama" value="<?= htmlspecialchars($data['profil']['nama'] ?? ''); ?>" class="pl-10 block w-full border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm py-2.5" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="kontak" value="<?= htmlspecialchars($data['profil']['kontak'] ?? ''); ?>" class="pl-10 block w-full border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm py-2.5">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="alamat" rows="3" class="pl-10 block w-full border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm py-2" required><?= htmlspecialchars($data['profil']['alamat'] ?? ''); ?></textarea>
                    </div>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi Singkat</label>
                    <textarea name="deskripsi" rows="4" class="block w-full border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm py-2"><?= htmlspecialchars($data['profil']['deskripsi'] ?? ''); ?></textarea>
