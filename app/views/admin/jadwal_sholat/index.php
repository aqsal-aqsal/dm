<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        ...
        <p class="text-gray-600">Atur waktu sholat untuk masjid.</p>
    </div>
    <a href="<?= BASEURL; ?>/admin/jadwal_sholat_add" class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-sm flex items-center">
